    ...
    const fetchLatestAttempt = async () => {
      ...
      try {
        ...
        if (attemptData.answersBySubject) {
          ...
          // proportional fallback when subject breakdown isn't stored
          const subjects = [
            { name: "Geography",   fraction: 0.25 },
            { name: "Polity",      fraction: 0.22 },
            { name: "History",     fraction: 0.28 },
            { name: "Mathematics", fraction: 0.25 },
          ];
