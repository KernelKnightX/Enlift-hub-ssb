...
const assessors = [
  {
    role: "Psychologist",
    observes: "Inner personality and unconscious patterns",
    detail: "The Psychologist never interacts with candidates directly. They work entirely from the written output of TAT, WAT, SRT and Self-Description. They look for thematic consistency — the same values, orientations and coping styles appearing across all four tests. Contradictions between tests are the primary concern.",
  },
  {
    role: "Group Testing Officer (GTO)",
    observes: "Behaviour in group and outdoor tasks",
...
const structuredDataArticle = {
  ...
  "@type": "Article",
  headline: "Complete Guide to Services Selection Board (SSB) – 5-Day Process, OLQs & Preparation",
  description:
    "Comprehensive guide covering the SSB 5-day assessment process, all 15 Officer-Like Qualities, psychological tests, GTO tasks, personal interview tips and preparation strategy.",
  author: { "@type": "Organization", name: "SSB Preparation Guide" },
  publisher: { "@type": "Organization", name: "SSB Preparation Guide" },
  datePublished: "2025-01-01",
  dateModified: "2025-03-01",
  keywords: ["SSB", "Services Selection Board", "OLQ", "Officer Like Qualities", "SSB preparation", "NDA", "CDS", "AFCAT"],
};
...
const structuredDataFAQ = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How many days does the SSB process take?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "The SSB is a 5-day process: Day 1 (OIR + PPDT screening), Day 2 (psychological tests — TAT, WAT, SRT, Self-Description), Days 3–4 (GTO outdoor group tasks), Day 4 or 5 (personal interview), and the final day (Conference where all assessors reconcile scores).",
      },
    },
    {
      "@type": "Question",
      name: "What are the 15 OLQs in SSB?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "The 15 Officer-Like Qualities are grouped into 4 factors: Planning & Organising (Effective Intelligence, Reasoning Ability, Organising Ability, Power of Expression), Social Adjustment (Social Adaptability, Cooperation, Sense of Responsibility, Initiative), Social Effectiveness (Self Confidence, Speed of Decision, Ability to Influence the Group, Liveliness), and Dynamism (Determination, Courage, Stamina).",
      },
    },
    {
      "@type": "Question",
      name: "What is the SSB selection rate?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "SSB selection rates are typically 2–5% of candidates who appear at a centre. The board has no quota — it may recommend zero candidates if no one meets the standard.",
      },
    },
    {
      "@type": "Question",
      name: "Can you attempt SSB multiple times?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Multiple attempts are permitted and common. Many recommended candidates appear 3–4 times. However, returning without significant personal growth rarely changes the outcome.",
      },
    },
  ],
};
...
const css = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sp-hero-img-wrap {
    ...
    height: 500px; overflow: hidden; position: relative; background: #ccc;
  }
  .sp-hero-img-wrap img { width: 100%; height: 100%; object-fit: cover; object-position: center top; }
  .sp-hero-fade {
    position: absolute; bottom: 0; left: 0; right: 0; height: 120px;
    background: linear-gradient(transparent, rgba(250,250,248,0.9));
  }
  .sp-hero-cap {
    position: absolute; bottom: 20px; left: 48px;
    font-size: 12px; color: #666; font-family: system-ui; letter-spacing: 0.04em;
  }
  ...
  .sp-intro {
    ...
    padding: 72px 0 64px; border-bottom: 1px solid #e0ddd8; position: relative;
  }
  .sp-intro::after {
    content: ''; position: absolute;
    left: 50%; top: 72px; bottom: 64px;
    width: 1px; background: #e0ddd8; transform: translateX(-50%);
  }
  ...
  .sp-stats {
    ...
    gap: 1px; margin-top: 40px; background: #666;
  }
  ...
  .sp-days-hdr {
    ...
    margin-bottom: 52px; flex-wrap: wrap; gap: 8px;
  }
  .sp-days-lbl { font-size: 11px; color: #888; letter-spacing: 0.12em; text-transform: uppercase; font-family: system-ui; }
  .sp-day {
    display: grid; grid-template-columns: 190px 1fr; gap: 60px;
    padding: 40px 0; border-top: 1px solid #e8e6e1;
  }
  ...
  .sp-tag {
    font-size: 12px; color: #555; font-family: system-ui; line-height: 1.6;
    border-left: 2px solid #d0cdc8; padding-left: 10px; margin-bottom: 4px;
  }
  ...
  .sp-olq-intro { font-size: 1rem; line-height: 1.85; color: #444; margin-bottom: 52px; width: 100%; }
  ...
  .sp-olq-note  {
    margin-top: 36px; padding: 28px 36px; background: #f0ede8;
    border-left: 3px solid #1a1a1a; font-size: 0.95rem; line-height: 1.8; color: #333;
  }
  ...
  .sp-pq-wrap {
    width: calc(100% + 96px); margin-left: -48px; height: 380px;
    overflow: hidden; position: relative; background: #c8c5be;
  }
  ...
  .sp-pq-text {
    ...
    font-size: clamp(1rem, 2.2vw, 1.55rem); font-weight: 300; line-height: 1.45;
  }
  ...
  /* ── CTA ── */
  .sp-cta {
    padding: 60px 0 80px; border-top: 1px solid #e0ddd8;
    display: flex; justify-content: space-between; align-items: center;
  ...
  .sp-btn-dark {
    padding: 13px 26px; background: #1a1a1a; color: #fff;
    border: none; cursor: pointer; font-size: 13px; letter-spacing: 0.04em;
    font-family: system-ui; transition: background 0.2s;
  }
  .sp-btn-dark:hover { background: #333; }
  .sp-btn-out {
    padding: 13px 26px; background: transparent; color: #1a1a1a;
    border: 1px solid #1a1a1a; cursor: pointer; font-size: 13px;
    letter-spacing: 0.04em; font-family: system-ui; transition: all 0.2s;
  }
  .sp-btn-out:hover { background: #1a1a1a; color: #fff; }

  /* ── RESPONSIVE ── */
  @media (max-width: 1100px) {
    .sp-intro      { grid-template-columns: 1fr; gap: 48px; }
    .sp-intro::after { display: none; }
  ...
  @media (max-width: 580px) {
    ...
    .sp-h1    { font-size: 1.4rem; line-height: 1.2; }
    ...
    .sp-imgs-row, .sp-imgs-caps { grid-template-columns: 1fr; }
...
const faqs = [
  {
    q: "How many days does the SSB process take?",
    a: "The SSB is a 5-day process: Day 1 (OIR + PPDT screening), Day 2 (psychological tests — TAT, WAT, SRT, Self-Description), Days 3–4 (GTO outdoor tasks), Day 4 or 5 (personal interview with the IO), and the final day (Conference where all assessors reconcile independent scores).",
  },
  {
    q: "What are the 15 OLQs tested in SSB?",
    a: "The 15 Officer-Like Qualities are grouped into 4 factors: Planning & Organising (Effective Intelligence, Reasoning Ability, Organising Ability, Power of Expression), Social Adjustment (Social Adaptability, Cooperation, Sense of Responsibility, Initiative), Social Effectiveness (Self Confidence, Speed of Decision, Ability to Influence the Group, Liveliness), and Dynamism (Determination, Courage, Stamina).",
  },
  {
    q: "What is the SSB selection rate?",
    a: "Selection rates are typically 2–5% of candidates who appear at a centre. The board has no quota — if a batch produces no recommended candidates, it recommends none. The standard is absolute, not relative.",
  },
  {
    q: "Can you attempt SSB multiple times?",
    a: "Yes, multiple attempts are permitted and common. Many recommended candidates appear 3–4 times. However, returning without significant personal growth rarely changes the outcome — the SSB tests who you are, not how well you know the process.",
  },
  {
    q: "Which entries use the SSB for selection?",
    a: "SSB results are used for NDA, CDS, TES, UES, NCC Special Entry, AFCAT and other officer entry programmes across the Indian Army, Navy and Air Force. The same board structure and OLQ framework applies regardless of service branch.",
  },
];
...
export default function SSBAboutPage() {
  ...
  return (
    <div className="sp">
      ...
      {/* ── SEO: Structured data injected into <head> via portal-style script tags ── */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredDataArticle) }}
      />
      <script
        type="application/ld+json"
      ...
      <header className="sp-hero">
        ...
        <h1 className="sp-h1">
          SSB Complete Guide: Complete Process, OLQs &amp; Preparation 
        </h1>
        <p className="sp-sub">
        ...
        <div className="sp-hero-img-wrap">
          <img src="/ssb-crack.png" alt="SSB candidates during the Services Selection Board assessment" loading="eager" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          <div className="sp-hero-fade" />
          <div className="sp-hero-cap">Recoomended student from ssb | image: ssb crack</div>
        </div>
      </header>
      ...
      <main className="sp-main">
        ...
        {/* ── INTRO ── */}
        <section className="sp-intro" aria-label="Why SSB exists">
          <div>
          ...
          <div>
            ...
            <div className="sp-stats">
              {([['5 Days', 'Duration'], ['3', 'Independent assessors'], ['15 OLQs', 'Qualities evaluated']] as const).map(([v, l]) => (
        ...
        {/* ── FIVE DAYS ── */}
        <section className="sp-days" aria-label="SSB 5-day process">
          <div className="sp-days-hdr">
            <h2 className="sp-h2" style={{ margin: 0 }}>The five-day SSB assessment, stage by stage</h2>
        ...
        {/* ── IMAGES ── */}
        <section className="sp-imgs" aria-label="SSB assessment photos">
          <div className="sp-imgs-row">
            <div className="sp-img-box">
              <img src="/screening.avif" alt="SSB psychology tests — TAT WAT SRT on Day 2" loading="lazy" onError={(e) => { e.currentTarget.parentElement!.style.background = '#bbb'; e.currentTarget.remove(); }} />
            </div>
            <div className="sp-img-box">
              <img src="/GTO.jpg" alt="SSB GTO outdoor group tasks" loading="lazy" onError={(e) => { e.currentTarget.parentElement!.style.background = '#aaa'; e.currentTarget.remove(); }} />
            </div>
            <div className="sp-img-box">
              <img src="/SSBIO.jpg" alt="SSB personal interview with Interviewing Officer" loading="lazy" onError={(e) => { e.currentTarget.parentElement!.style.background = '#b8b5ae'; e.currentTarget.remove(); }} />
            </div>
          </div>
        ...
        {/* ── OLQs ── */}
        <section className="sp-olqs" aria-label="15 Officer Like Qualities">
          <div style={{ fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#888', fontFamily: 'system-ui', marginBottom: '14px' }}>
            Assessment Framework
          </div>
          <h2 className="sp-h2">The 15 Officer-Like Qualities (OLQs)</h2>
          <p className="sp-olq-intro">
            Established by the Defence Institute of Psychological Research, the 15 OLQs are organised into four factors. Every test, task and interview generates evidence for or against each quality. The board does not expect perfection in all 15 — it expects balanced, consistent, authentic expression of most.
          </p>
        ...
        {/* ── ASSESSORS ── */}
        <section className="sp-assessors" aria-label="SSB assessors">
        ...
        {/* ── MISTAKES ── */}
        <section className="sp-mistakes" aria-label="Common SSB mistakes">
        ...
        {/* ── PREP ── */}
        <section className="sp-prep" aria-label="SSB preparation guide">
          <div className="sp-prep-grid">
            ...
            <div>
              ...
              {([
                ...
                ["Months 6+",    "Mock interviews on your PIQ. Lecturette practice on diverse topics. Group discussions where someone gives you candid feedback."],
        ...
        {/* ── PULLQUOTE ── */}
        <section className="sp-pq" aria-label="Key insight">
          <div className="sp-pq-wrap">
            <img src="/FRD.png" alt="SSB GTO obstacle course" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
        ...
        {/* ── FAQ — interactive + structured data for Google rich snippets ── */}
        <section className="sp-faq" aria-label="SSB frequently asked questions">
          <div className="sp-faq-lbl">Common Questions</div>
          <h2 className="sp-h2">SSB Frequently Asked Questions</h2>
        ...
        {/* ── CTA ── */}
        <section className="sp-cta" aria-label="Next steps">
          <div>
