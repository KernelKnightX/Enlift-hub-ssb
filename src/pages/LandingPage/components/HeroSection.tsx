...
export function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 text-white relative overflow-hidden">
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/3 h-3/4 opacity-20">
        <div className="absolute inset-0 bg-gradient-to-l from-green-500/30 to-transparent rounded-l-3xl" />
        <div className="absolute inset-0 rotate-12 bg-gradient-to-l from-green-400/20 to-transparent rounded-full" />
      </div>

      {/* Floating accent shapes */}
      <div className="absolute top-32 left-10 w-32 h-32 border border-green-500/20 rounded-full animate-pulse" />
      <div className="absolute bottom-32 right-20 w-20 h-20 bg-green-500/10 rounded-full" />
      <div className="absolute top-1/3 right-1/4 w-16 h-16 border border-green-400/30 rounded-lg rotate-45" />
