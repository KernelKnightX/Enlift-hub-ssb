...
export default function WATInstructionPage() {
    ...
    <div className="min-h-screen bg-slate-50 px-4 py-4 sm:px-6 sm:py-6">
      ...
      <div className="max-w-6xl mx-auto bg-white border rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="bg-sky-100 text-sky-900 rounded-md px-3 py-3 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">
          ...
          <br />
          <br />
          You will see a <strong>word</strong> for <strong>15 seconds</strong>.
          Write a <strong>complete sentence</strong> using that word.
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 text-xs sm:text-sm text-slate-700">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-1 ml-6 list-disc">
                <li><strong>Word Display:</strong> 15 seconds per word</li>
                <li><strong>Total Time:</strong> 15 minutes (60 words)</li>
                <li><strong>Auto-advance:</strong> After each word</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 ml-6 list-disc">
                <li>Write a meaningful sentence</li>
                <li>Use positive and impactful language</li>
                <li>Show leadership and OLQs</li>
                <li>Be quick but thoughtful</li>
              </ul>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-1 ml-6 list-disc">
                <li>A complete, grammatically correct sentence</li>
                <li>Use the given word meaningfully</li>
                <li>Show positive thinking</li>
                <li>Demonstrate OLQs (Officer Like Qualities)</li>
            ...
            <div className="border rounded-md p-3 sm:p-4 bg-slate-50">
              ...
              <p className="text-xs sm:text-sm leading-relaxed">
                Focus on <strong>positive themes</strong>, <strong>leadership</strong>,
                <strong> discipline</strong>, and <strong>national service</strong>.
                Avoid negative words, complaints, or pessimistic statements.
              </p>
            </div>
        ...
        <div className="mt-6 sm:mt-8">
          <Button
            ...
            onClick={() => navigate('/wat/sets')}
          >
            🚀 Start WAT Test
          </Button>
          <p className="text-xs text-muted-foreground mt-2">
            Word appears for 15 seconds
          </p>
        </div>
